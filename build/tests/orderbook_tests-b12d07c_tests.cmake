...
add_test( [==[PnL buy then sell updates cash/invenotry and mark-to-market]==] /Users/fglemu/Desktop/orderbook/build/tests/orderbook_tests [==[PnL buy then sell updates cash/invenotry and mark-to-market]==]  )
set_tests_properties( [==[PnL buy then sell updates cash/invenotry and mark-to-market]==] PROPERTIES WORKING_DIRECTORY /Users/fglemu/Desktop/orderbook/build/tests)
add_test( [==[Market buy consumes asks best-first]==] /Users/fglemu/Desktop/orderbook/build/tests/orderbook_tests [==[Market buy consumes asks best-first]==]  )
set_tests_properties( [==[Market buy consumes asks best-first]==] PROPERTIES WORKING_DIRECTORY /Users/fglemu/Desktop/orderbook/build/tests)
add_test( [==[baseline_market_making: empty orderbook]==] /Users/fglemu/Desktop/orderbook/build/tests/orderbook_tests [==[baseline_market_making: empty orderbook]==]  )
set_tests_properties( [==[baseline_market_making: empty orderbook]==] PROPERTIES WORKING_DIRECTORY /Users/fglemu/Desktop/orderbook/build/tests)
add_test( [==[baseline_market_making: best bid and ask]==] /Users/fglemu/Desktop/orderbook/build/tests/orderbook_tests [==[baseline_market_making: best bid and ask]==]  )
set_tests_properties( [==[baseline_market_making: best bid and ask]==] PROPERTIES WORKING_DIRECTORY /Users/fglemu/Desktop/orderbook/build/tests)
add_test( [==[no buy no ask]==] /Users/fglemu/Desktop/orderbook/build/tests/orderbook_tests [==[no buy no ask]==]  )
set_tests_properties( [==[no buy no ask]==] PROPERTIES WORKING_DIRECTORY /Users/fglemu/Desktop/orderbook/build/tests)
set( orderbook_tests_TESTS [==[Add: resting order goes to correct side and best price updates]==] [==[Crossing generates fills at maker prices with FIFO across levells]==] [==[Cancel removes resting order and empty level]==] [==[Partial Fill: taker < maker]==] [==[ maker stays in book with reduced size]==] [==[Partial fill: taker spans multiple makers]==] [==[ remaining stays in orderbook]==] [==[Full fill: maker and taker request same amount. Fill goes through. Both are gone.]==] [==[Cancel non-existent order id returns false and does nothing]==] [==[Cancel prev order removes level and updates best price]==] [==[Snapshot returns top n levels with summed qty]==] [==[OrderIdGen is monotonic and unique]==] [==[csv logger writes header + rows]==] [==[PnL buy then sell updates cash/invenotry and mark-to-market]==] [==[Market buy consumes asks best-first]==] [==[baseline_market_making: empty orderbook]==] [==[baseline_market_making: best bid and ask]==] [==[no buy no ask]==])
